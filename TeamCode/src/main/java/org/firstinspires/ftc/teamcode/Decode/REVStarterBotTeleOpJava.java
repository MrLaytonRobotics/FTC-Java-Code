...
public class REVStarterBotTeleOpJava extends LinearOpMode {
    ...
    /**
     * The bank shot (close) near velocity is intended for launching balls touching or a few inches from the goal.
    ...
    /**
     * The (away from the goal) far power velocity is intended for launching balls a few feet from the goal. It may require adjusting the deflector.
     * When running this function, the flywheel will spin up and the Core Hex will wait before balls can be fed.
     * The servo will spin until the bumper is released.
     */
